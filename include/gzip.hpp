...
public:
    static size_t
    compress(const std::string &input_path, std::ostream &output_stream, std::function<void()> update_callback = []{});
    ...
    static std::size_t
    compressChunk(std::ostream &output_stream, const std::ifstream &input_file, z_stream &deflate_stream,
